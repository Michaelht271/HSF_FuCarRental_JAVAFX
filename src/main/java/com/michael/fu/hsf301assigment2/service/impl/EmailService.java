...
import com.michael.fu.hsf301assigment2.service.interfaces.NotificationService;
...
public class EmailService extends BaseService implements NotificationService {
    ...
    public void sendOtpVerification(String email, String otp) {
        ...
        """.formatted(otp);
        sendRawEmail(subject, email, content);
    }
    private void sendRawEmail(String subject, String to, String contentHtml) {
        try {
